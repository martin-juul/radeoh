...
namespace Radeoh.Services.ApiService
{
    ...
    public class RequestPathAttribute : Attribute
    {
        ...
        {
            if (restRequest.GetType().GetCustomAttributes(typeof(RequestPathAttribute), true).FirstOrDefault() is
                RequestPathAttribute attribute)
            {
        ...
        {
            if (typeof(T).GetCustomAttributes(typeof(RequestPathAttribute), true).FirstOrDefault() is
                RequestPathAttribute attribute)
            {
                return attribute.RestApiPath;
            }
